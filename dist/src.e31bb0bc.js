...
},{"./Util":"../node_modules/konva/lib/Util.js","./Factory":"../node_modules/konva/lib/Factory.js","./Node":"../node_modules/konva/lib/Node.js","./Validators":"../node_modules/konva/lib/Validators.js"}],"../node_modules/konva/lib/PointerEvents.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Global_1 = require("./Global");
...
},{"./Util":"../node_modules/konva/lib/Util.js","./Container":"../node_modules/konva/lib/Container.js","./Node":"../node_modules/konva/lib/Node.js","./Factory":"../node_modules/konva/lib/Factory.js","./Canvas":"../node_modules/konva/lib/Canvas.js","./Validators":"../node_modules/konva/lib/Validators.js","./Shape":"../node_modules/konva/lib/Shape.js","./Global":"../node_modules/konva/lib/Global.js"}],"../node_modules/konva/lib/FastLayer.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./Util":"../node_modules/konva/lib/Util.js","./Layer":"../node_modules/konva/lib/Layer.js","./Global":"../node_modules/konva/lib/Global.js"}],"../node_modules/konva/lib/Group.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"../Util":"../node_modules/konva/lib/Util.js","../Factory":"../node_modules/konva/lib/Factory.js","../Shape":"../node_modules/konva/lib/Shape.js","../Global":"../node_modules/konva/lib/Global.js","../Validators":"../node_modules/konva/lib/Validators.js"}],"../node_modules/konva/lib/shapes/RegularPolygon.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./_FullInternals":"../node_modules/konva/lib/_FullInternals.js"}],"components/Widget.coffee":[function(require,module,exports) {
"use strict";
...
var Widget = /*#__PURE__*/function () {
  ...
  _createClass(Widget, [{
    key: "onEvent",
    value: function onEvent(event, widget, callback) {
      if (callback) {
        return widget.on(event, function (evt) {
          return callback(evt);
        });
      }
    }
    ...
    key: "onClick",
    value: function onClick(callback, widget) {
      return this.onEvent('click', widget, callback);
    }
  }, {
    key: "onMouseEnter",
    value: function onMouseEnter(callback, widget) {
      return this.onEvent('mouseenter', widget, callback);
    }
  }, {
    key: "onMouseLeave",
    value: function onMouseLeave(callback, widget) {
      return this.onEvent('mouseleave', widget, callback);
    }
  }]);
...
},{}],"components/Stage.coffee":[function(require,module,exports) {
"use strict";
...
var _Widget2 = require("./Widget.coffee");
...
var Stage = /*#__PURE__*/function (_Widget) {
  ...
  function Stage(_ref) {
    ...
    _this.stage = new Konva.Stage(props); // Listeners

    _this.onClick(props.onClick, _this.stage);

    _this.stage.add(layer.layer);
  ...
  _createClass(Stage, null, [{
    ...
    value: function create(container) {
      return "<div id=\"".concat(container, "\" class=\"canvas\"></div>");
    }
  }]);
...
exports.Stage = Stage;
},{"./Widget.coffee":"components/Widget.coffee"}],"components/Layer.coffee":[function(require,module,exports) {
"use strict";
...
exports.Layer = Layer;
},{}],"components/Star.coffee":[function(require,module,exports) {
"use strict";
...
var Star = /*#__PURE__*/function (_Widget) {
  _inherits(Star, _Widget);
  ...
  function Star(args) {
    ...
    _this = _super.call(this);
    _this.shape = new Konva.Star(args); // Listeners

    _this.onClick(args.onClick, _this.shape);

    _this.onMouseEnter(args.onMouseEnter, _this.shape);

    _this.onMouseLeave(args.onMouseLeave, _this.shape);
  ...
  _createClass(Star, null, [{
    ...
    key: "getPositionStar",
    value: function getPositionStar(stage, index) {
      var angle, radius;
      radius = 150;
      angle = index * 1.25;
      return {
...
exports.Star = Star;
},{"./Widget.coffee":"components/Widget.coffee"}],"components/Rect.coffee":[function(require,module,exports) {
"use strict";
...
var Rect = function Rect(args) {
  _classCallCheck(this, Rect);

  this.shape = new Konva.Rect(args);
};

exports.Rect = Rect;
},{}],"components/App.coffee":[function(require,module,exports) {
"use strict";
...
var _Stage = require("./Stage.coffee");

var _Layer = require("./Layer.coffee");

var _Star = require("./Star.coffee");

var _Rect = require("./Rect.coffee");
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    key: "runMain",
    value: function runMain() {
      var _this = this;

      this.render(_Stage.Stage.create(this.model.main.container));
      return this.main = new _Stage.Stage({
        props: _objectSpread(_objectSpread({}, this.model.main), {}, {
          onClick: function onClick(e) {
            if (e.target.getType() !== 'Shape') {
              _this.preview.stage.findOne(function (node) {
                return node.getType() === 'Shape';
              }).setAttrs({
                fill: _this.model.rect.fill
              });

              return _this.preview.stage.batchDraw();
            }
          }
        }),
        layer: new _Layer.Layer({
          childs: this.model.colors.map(function (color, index) {
            return new _Star.Star(_objectSpread(_objectSpread(_objectSpread({}, _Star.Star.create({
              fill: color
            })), _Star.Star.getPositionStar(_this.model.main, index)), {}, {
              y: _this.model.main.height / 2 + Math.sin(index * 1.25) * 150,
              ...
              onMouseEnter: function onMouseEnter(e) {
                var stage;
                stage = _this.main.stage.container();
                return stage.style.cursor = 'pointer';
              },
              onMouseLeave: function onMouseLeave(e) {
                var stage;
                stage = _this.main.stage.container();
                return stage.style.cursor = 'default';
              }
            }));
          })
        })
    ...
    value: function runPreview() {
      this.render(_Stage.Stage.create(this.model.preview.container));
      return this.preview = new _Stage.Stage({
        props: this.model.preview,
        layer: new _Layer.Layer({
          childs: [new _Rect.Rect(_objectSpread(_objectSpread({}, this.model.rect), {}, {
            x: 0,
            y: 0
          }))]
        })
    ...
    value: function render() {
      ...
      for (i = 0, len = args.length; i < len; i++) {
        child = args[i];
        results.push(this.root.insertAdjacentHTML('beforeend', child));
      }
...
exports.App = App;
},{"./Stage.coffee":"components/Stage.coffee","./Layer.coffee":"components/Layer.coffee","./Star.coffee":"components/Star.coffee","./Rect.coffee":"components/Rect.coffee"}],"model.coffee":[function(require,module,exports) {
"use strict";
...
var _App = require("./components/App.coffee");

var _model = _interopRequireDefault(require("./model.coffee"));
...
},{"konva":"../node_modules/konva/lib/index.js","./components/App.coffee":"components/App.coffee","./model.coffee":"model.coffee","./styles/main.css":"styles/main.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
